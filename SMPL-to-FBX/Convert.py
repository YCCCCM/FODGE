...
def getArg():
    ...
    parser.add_argument("--input_dir", type=str, default="motions")
    parser.add_argument(
        "--fbx_source_path",
        type=str,
        default="ybot3.fbx",
    )
    parser.add_argument("--output_dir", type=str, default="fbx_out")
...
if __name__ == "__main__":
    ...
    out = os.system(f" FbxFormatConverter.exe -c {output_dir} -binary")
